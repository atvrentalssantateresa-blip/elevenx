              ...
              >
                ...
                <div className="relative h-24 overflow-hidden">
                  ...
                  <div className="absolute top-2 left-2">
                    <span className="text-[10px] font-bold bg-black/50 backdrop-blur-sm text-white/90 px-2 py-0.5 rounded-full">{match.group_stage || 'World Cup 2026'}</span>
                  </div>
                ...
                <div className="p-4">
                  ...
                  <div className="flex items-center justify-between mb-4">
                    <div className="text-center flex-1">
                      <div className="text-2xl mb-1">{match.team_a_flag || '🏳️'}</div>
                    ...
                    <div className="flex flex-col items-center gap-0.5 px-2">
                      ...
                      <span className="text-[9px] text-muted-foreground">{matchDate ? matchDate.toLocaleDateString('en-US', { month: 'short', day: 'numeric' }) : 'TBD'}</span>
                    </div>
                    <div className="text-center flex-1">
                      <div className="text-2xl mb-1">{match.team_b_flag || '🏳️'}</div>
