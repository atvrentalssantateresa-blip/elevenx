        ...
        <div className="relative z-10 space-y-5">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-wrap items-center gap-3">
              <div className="flex items-center gap-2 px-3 py-1.5 rounded-xl" style={{ background: '#ab99f5' }}>
                <span className="text-[10px] font-bold text-white tracking-wide">POWERED BY</span>
                <svg className="w-16 h-5" viewBox="0 0 100 25" fill="none" xmlns="http://www.w3.org/2000/svg">
